...
class Experiment():
    ...
    def __init__(self, Xsamples=None, ysamples=None, obs_noise_stdev=1e-2, ML_est=True):
        # As default, the noise level is chosen as small as possible (empirical)
        ...
        self._model = None
        self.ML_optimizer = optax.adam(learning_rate=1e-1)  # hard-coded for now.
        ...
        self.default_prior_func = (lambda x: mean)
        ...
        if ML_est:
            ...
            optimal_param_dict, _ = ML_for_hyperparams(Xsamples, ysamples, self.ML_optimizer,
                                                       ...
                                                       obs_noise_stdev=obs_noise_stdev, prior_mean=self.default_prior_func,
    ...
    def model(self, kernel_type='RBF', kernel_hyperparam_kwargs=None, obs_noise_stdev=1e-6):  # more parameters?
        ...
        parameters, populate the 'kernel_hyperparam_kwargs' with the relevant keys-values.
        ...
        self._model.fit(self.Xsamples, self.ysamples, compute_cov=True)
